...
\method-IA couples behaviour to the ego less than half as strongly as H4 (separation 0.15 vs.\ 0.33) and under-predicts stopping (0.14 vs.\ a base rate of 0.22), consistent with the interaction-weighted training distribution shifting its behavioural calibration. Across Tables~\ref{tab:adefde} and \ref{tab:behavior}, H4 --- not the FID-best \method-IA --- is the best-\emph{conditioned} model.
