#!/bin/bash -l
#SBATCH --job-name=eval_h6_ep3299_cfg10
#SBATCH --output=/hnvme/workspace/v103fe12-ped_gen/outputs/eval_h6_ep3299_cfg10_%j.txt
#SBATCH --time=4:00:00
#SBATCH --nodes=1
...
# Evaluate H6 (FREEZE_EGO=False, trans_dec) at epoch=3299, CFG=10
# epoch=3299: best R@1 checkpoint (training-time val: FID=5.273, R@1=0.398)
# Running intermediate eval while seg-2 training continues
EPOCH=3299
