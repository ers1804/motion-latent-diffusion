#!/bin/bash -l
#SBATCH --job-name=resume_h4_diffusion
#SBATCH --output=/hnvme/workspace/v103fe12-ped_gen/outputs/resume_h4_diffusion_%j.txt
...
# Resume H4 diffusion training (trans_dec) from latest checkpoint
# Submit after segment 1 (~4400 epochs) to reach epoch ~5000
python -m train \
...
--overrides \
    ...
    "TRAIN.RESUME=/hnvme/workspace/v103fe12-ped_gen/models/mld/ego_motion_diffusion_h4_trans_dec"
