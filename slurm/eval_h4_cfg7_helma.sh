#!/bin/bash -l
#SBATCH --job-name=eval_h4_cfg7
#SBATCH --output=/hnvme/workspace/v103fe12-ped_gen/outputs/eval_h4_cfg7_%j.txt
#SBATCH --time=4:00:00
#SBATCH --nodes=1
...
# Evaluate H4 (trans_dec) at CFG=7 — best FID/R-prec tradeoff
EPOCH=4399
