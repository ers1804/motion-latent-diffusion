#!/bin/bash -l
#SBATCH --job-name=rv_eval_uncond_pipe_ep4999
#SBATCH --output=/hnvme/workspace/v103fe12-ped_gen/outputs/rv_eval_uncond_pipe_ep4999_%j.txt
#SBATCH --time=4:00:00
#SBATCH --nodes=1
...
EPOCH=1199
CHECKPOINT=/hnvme/workspace/v103fe12-ped_gen/models/mld/ego_motion_diffusion_uncond_pipeline/checkpoints/epoch=4999.ckpt
...
--overrides \
    ...
    "NAME=rv_eval_uncond_pipe_ep4999" \
