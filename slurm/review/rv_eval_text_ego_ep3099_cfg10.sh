#!/bin/bash -l
#SBATCH --job-name=rv_eval_text_ego_ep3099_cfg10
#SBATCH --output=/hnvme/workspace/v103fe12-ped_gen/outputs/rv_eval_text_ego_ep3099_cfg10_%j.txt
#SBATCH --time=4:00:00
#SBATCH --nodes=1
...
--overrides \
    ...
    "NAME=rv_eval_text_ego_ep3099_cfg10" \
