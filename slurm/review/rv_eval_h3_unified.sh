#!/bin/bash -l
#SBATCH --job-name=rv_eval_h3_unified
#SBATCH --output=/hnvme/workspace/v103fe12-ped_gen/outputs/rv_eval_h3_unified_%j.txt
#SBATCH --time=4:00:00
#SBATCH --nodes=1
...
# EPOCH=4399: best training-time val checkpoint (FID=3.770, R@1=0.535, both peak here)
EPOCH=4399
