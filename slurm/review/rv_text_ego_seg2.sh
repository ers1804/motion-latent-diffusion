#!/bin/bash -l
#SBATCH --job-name=rv_text_ego_seg2
#SBATCH --output=/hnvme/workspace/v103fe12-ped_gen/outputs/rv_text_ego_seg2_%j.txt
...
--nodebug \
--overrides \
    "NAME=ego_motion_diffusion_text_ego" \
    "TRAIN.RESUME=/hnvme/workspace/v103fe12-ped_gen/models/mld/ego_motion_diffusion_text_ego" \
    "SEED_VALUE=1234" \
