#!/bin/bash -l
#SBATCH --job-name=rv_h4_randinit_ego
#SBATCH --output=/hnvme/workspace/v103fe12-ped_gen/outputs/rv_h4_randinit_ego_%j.txt
...
--nodebug \
--overrides \
    "NAME=ego_motion_diffusion_h4_randinit_ego" \
    "SEED_VALUE=1234" \
    ...
    "LOGGER.WANDB.RESUME_ID=ego_motion_diffusion_h4_randinit_ego" \
