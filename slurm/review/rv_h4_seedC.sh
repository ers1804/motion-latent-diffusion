#!/bin/bash -l
#SBATCH --job-name=rv_h4_seedC
#SBATCH --output=/hnvme/workspace/v103fe12-ped_gen/outputs/rv_h4_seedC_%j.txt
...
--nodebug \
--overrides \
    "NAME=ego_motion_diffusion_h4_seedC" \
    "SEED_VALUE=3456" \
    ...
    "LOGGER.WANDB.RESUME_ID=ego_motion_diffusion_h4_seedC" \
