...
# EPOCH=1799: best training-time val checkpoint (FID=3.770, R@1=0.535, both peak here)
EPOCH=1799
CHECKPOINT=/hnvme/workspace/v103fe12-ped_gen/models/mld/ego_motion_rv_eval_h4_seedC_ep1799/checkpoints/epoch=${EPOCH}.ckpt
