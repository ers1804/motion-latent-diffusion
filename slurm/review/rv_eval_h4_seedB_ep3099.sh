#!/bin/bash -l
#SBATCH --job-name=rv_eval_h4_seedB_ep3099
#SBATCH --output=/hnvme/workspace/v103fe12-ped_gen/outputs/rv_eval_h4_seedB_ep3099_%j.txt
#SBATCH --time=4:00:00
#SBATCH --nodes=1
...
# EPOCH=3099: best training-time val checkpoint (FID=3.770, R@1=0.535, both peak here)
EPOCH=3099
CHECKPOINT=/hnvme/workspace/v103fe12-ped_gen/models/mld/ego_motion_diffusion_h4_seedB/checkpoints/epoch=${EPOCH}.ckpt
