#!/bin/bash -l
#SBATCH --job-name=rv_h2_seedC_seg2
#SBATCH --output=/hnvme/workspace/v103fe12-ped_gen/outputs/rv_h2_seedC_seg2_%j.txt
...
--nodebug \
--overrides \
    "NAME=ego_motion_diffusion_h2_seedC" \
    "TRAIN.RESUME=/hnvme/workspace/v103fe12-ped_gen/models/mld/ego_motion_diffusion_h2_seedC" \
    "SEED_VALUE=3456" \
    ...
    "LOGGER.WANDB.RESUME_ID=ego_motion_diffusion_h2_seedC" \
