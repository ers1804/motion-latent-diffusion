#!/bin/bash -l
#SBATCH --job-name=rv_h2_nopipeline_seg2
#SBATCH --output=/hnvme/workspace/v103fe12-ped_gen/outputs/rv_h2_nopipeline_seg2_%j.txt
...
--nodebug \
--overrides \
    "NAME=ego_motion_diffusion_h2_nopipeline" \
    "TRAIN.RESUME=/hnvme/workspace/v103fe12-ped_gen/models/mld/ego_motion_diffusion_h2_nopipeline" \
    "SEED_VALUE=1234" \
    ...
    "LOGGER.WANDB.RESUME_ID=ego_motion_diffusion_h2_nopipeline" \
