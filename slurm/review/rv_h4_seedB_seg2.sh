#!/bin/bash -l
#SBATCH --job-name=rv_h4_seedB_seg2
#SBATCH --output=/hnvme/workspace/v103fe12-ped_gen/outputs/rv_h4_seedB_seg2_%j.txt
...
--nodebug \
--overrides \
    "NAME=ego_motion_diffusion_h4_seedB" \
    "TRAIN.RESUME=/hnvme/workspace/v103fe12-ped_gen/models/mld/ego_motion_diffusion_h4_seedB" \
    "SEED_VALUE=2345" \
    ...
    "LOGGER.WANDB.RESUME_ID=ego_motion_diffusion_h4_seedB" \
