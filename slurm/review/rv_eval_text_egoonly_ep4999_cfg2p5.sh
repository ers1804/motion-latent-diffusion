#!/bin/bash -l
#SBATCH --job-name=rv_eval_text_egoonly_ep4999_cfg2p5
#SBATCH --output=/hnvme/workspace/v103fe12-ped_gen/outputs/rv_eval_text_egoonly_ep4999_cfg2p5_%j.txt
#SBATCH --time=4:00:00
#SBATCH --nodes=1
...
# EPOCH=1199: best training-time val checkpoint (FID=3.770, R@1=0.535, both peak here)
EPOCH=1199
CHECKPOINT=/hnvme/workspace/v103fe12-ped_gen/models/mld/ego_motion_diffusion_text_egoonly/checkpoints/epoch=4999.ckpt
...
--overrides \
    ...
    "DATASET.EGOMOTION.CAPTIONS_PATH=/hnvme/workspace/v103fe12-ped_gen/motion-latent-diffusion/research/data/synth_captions.json" \
    "DATASET.EGOMOTION.CAPTION_VOCAB=egoonly" \
    "TEST.REPLICATION_TIMES=3" \
    "TEST.SPLIT=val" \
    "model.guidance_scale=2.5" \
    "NAME=rv_eval_text_egoonly_ep4999_cfg2p5" \
