#!/bin/bash -l
#SBATCH --job-name=rv_h2_seedB_seg2
#SBATCH --output=/hnvme/workspace/v103fe12-ped_gen/outputs/rv_h2_seedB_seg2_%j.txt
...
--overrides \
    ...
    "TRAIN.RESUME=/hnvme/workspace/v103fe12-ped_gen/models/mld/ego_motion_diffusion_h2_seedB" \
    "SEED_VALUE=2345" \
