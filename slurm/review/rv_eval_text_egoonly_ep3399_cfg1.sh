#!/bin/bash -l
#SBATCH --job-name=rv_eval_text_egoonly_ep3399_cfg1
#SBATCH --output=/hnvme/workspace/v103fe12-ped_gen/outputs/rv_eval_text_egoonly_ep3399_cfg1_%j.txt
#SBATCH --time=4:00:00
#SBATCH --nodes=1
...
--overrides \
    ...
    "TEST.SPLIT=val" \
    "model.guidance_scale=1" \
    "NAME=rv_eval_text_egoonly_ep3399_cfg1" \
