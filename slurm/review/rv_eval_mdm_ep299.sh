#!/bin/bash -l
#SBATCH --job-name=rv_eval_mdm_ep299
#SBATCH --output=/hnvme/workspace/v103fe12-ped_gen/outputs/rv_eval_mdm_ep299_%j.txt
#SBATCH --time=4:00:00
#SBATCH --nodes=1
...
# EPOCH=299: best training-time val checkpoint (FID=3.770, R@1=0.535, both peak here)
EPOCH=299
CHECKPOINT=/hnvme/workspace/v103fe12-ped_gen/models/mld/ego_motion_diffusion_mdm_style/checkpoints/epoch=${EPOCH}.ckpt
