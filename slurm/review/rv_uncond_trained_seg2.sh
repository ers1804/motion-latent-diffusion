#!/bin/bash -l
#SBATCH --job-name=rv_uncond_trained_seg2
#SBATCH --output=/hnvme/workspace/v103fe12-ped_gen/outputs/rv_uncond_trained_seg2_%j.txt
...
--nodebug \
--overrides \
    "NAME=ego_motion_diffusion_uncond_trained" \
    "TRAIN.RESUME=/hnvme/workspace/v103fe12-ped_gen/models/mld/ego_motion_diffusion_uncond_trained" \
    "SEED_VALUE=1234" \
    ...
    "LOGGER.WANDB.RESUME_ID=ego_motion_diffusion_uncond_trained" \
