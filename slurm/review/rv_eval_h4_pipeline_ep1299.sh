#!/bin/bash -l
#SBATCH --job-name=rv_eval_h4_pipeline_ep1299
#SBATCH --output=/hnvme/workspace/v103fe12-ped_gen/outputs/rv_eval_h4_pipeline_ep1299_%j.txt
#SBATCH --time=4:00:00
#SBATCH --nodes=1
...
EPOCH=1299
CHECKPOINT=/hnvme/workspace/v103fe12-ped_gen/models/mld/ego_motion_diffusion_h4_pipeline/checkpoints/epoch=${EPOCH}.ckpt
