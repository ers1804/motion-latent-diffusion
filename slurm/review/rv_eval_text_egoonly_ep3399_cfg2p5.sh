#!/bin/bash -l
#SBATCH --job-name=rv_eval_text_egoonly_ep3399_cfg2p5
#SBATCH --output=/hnvme/workspace/v103fe12-ped_gen/outputs/rv_eval_text_egoonly_ep3399_cfg2p5_%j.txt
#SBATCH --time=4:00:00
#SBATCH --nodes=1
...
EPOCH=1199
CHECKPOINT=/hnvme/workspace/v103fe12-ped_gen/models/mld/ego_motion_diffusion_text_egoonly/checkpoints/epoch=3399.ckpt
...
--overrides \
    ...
    "NAME=rv_eval_text_egoonly_ep3399_cfg2p5" \
