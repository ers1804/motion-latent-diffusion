#!/bin/bash -l
#SBATCH --job-name=rv_mdm_style
#SBATCH --output=/hnvme/workspace/v103fe12-ped_gen/outputs/rv_mdm_style_%j.txt
...
--overrides \
    ...
    "LOGGER.WANDB.RESUME_ID=ego_motion_diffusion_mdm_style" \
