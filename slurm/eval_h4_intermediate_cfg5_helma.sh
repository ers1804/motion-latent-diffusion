#!/bin/bash -l
#SBATCH --job-name=eval_h4_int_cfg5
#SBATCH --output=/hnvme/workspace/v103fe12-ped_gen/outputs/eval_h4_int_cfg5_%j.txt
#SBATCH --time=4:00:00
#SBATCH --nodes=1
...
# Evaluate H4 (trans_dec) at CFG=5 — end of segment-1 checkpoint
# Segment-1 ran for ~24h, reached epoch ~3279 but saves every 100; latest is epoch=3199
EPOCH=3199
