#!/bin/bash -l
#SBATCH --job-name=eval_h4_int_cfg10
#SBATCH --output=/hnvme/workspace/v103fe12-ped_gen/outputs/eval_h4_int_cfg10_%j.txt
#SBATCH --time=4:00:00
#SBATCH --nodes=1
...
# Evaluate H4 (trans_dec) at CFG=10 — intermediate epoch=3199
# Goal: characterize H4 FID/R-prec tradeoff curve vs H2 (H2 at CFG=10: FID=6.963, R-prec=0.767)
EPOCH=3199
