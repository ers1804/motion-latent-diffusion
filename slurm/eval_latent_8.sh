#!/bin/bash -l
#SBATCH --job-name=eval_latent_8
#SBATCH --output=/hnvme/workspace/v103fe12-ped_gen/outputs/eval_latent_8_%j.txt
#SBATCH --time=4:00:00
#SBATCH --nodes=1
...
# Update CHECKPOINT to the best available epoch after training completes
CHECKPOINT=/hnvme/workspace/v103fe12-ped_gen/models/mld/ego_motion_diffusion_interaction_crop_weighted_latent_8/checkpoints/epoch=4999.ckpt
