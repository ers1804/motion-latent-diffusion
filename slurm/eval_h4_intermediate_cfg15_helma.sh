#!/bin/bash -l
#SBATCH --job-name=eval_h4_int_cfg15
#SBATCH --output=/hnvme/workspace/v103fe12-ped_gen/outputs/eval_h4_int_cfg15_%j.txt
#SBATCH --time=4:00:00
#SBATCH --nodes=1
...
# Evaluate H4 (trans_dec) at CFG=15 — intermediate epoch=3199
# Goal: characterize H4 FID/R-prec tradeoff at high guidance (H2 at CFG=15: FID=7.400, R-prec=0.797)
EPOCH=3199
