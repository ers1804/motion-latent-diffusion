#!/bin/bash -l
#SBATCH --job-name=diffusion_h4_trans_dec
#SBATCH --output=/hnvme/workspace/v103fe12-ped_gen/outputs/diffusion_h4_trans_dec_%j.txt
...
# H4 diffusion training: trans_dec arch with full-sequence EgoEncoder
# Latent-4 VAE (same as H2), new cross-attention denoiser
# ~17s/epoch (same as H2 since latent-4), ~5000 epochs in 2 segments of 24h each
python -m train \
