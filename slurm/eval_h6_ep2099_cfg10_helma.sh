#!/bin/bash -l
#SBATCH --job-name=eval_h6_ep2099_cfg10
#SBATCH --output=/hnvme/workspace/v103fe12-ped_gen/outputs/eval_h6_ep2099_cfg10_%j.txt
#SBATCH --time=4:00:00
#SBATCH --nodes=1
...
# Evaluate H6 (FREEZE_EGO=False, trans_dec) at epoch=2099, CFG=10
# epoch=2099: best FID checkpoint (training-time val: FID=4.789, R@1=0.273)
EPOCH=2099
