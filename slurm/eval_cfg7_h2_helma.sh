#!/bin/bash -l
#SBATCH --job-name=eval_cfg7_h2
#SBATCH --output=/hnvme/workspace/v103fe12-ped_gen/outputs/eval_cfg7_h2_%j.txt
#SBATCH --time=4:00:00
#SBATCH --nodes=1
...
# Evaluate H2 epoch=4399 at CFG=7 — explore FID/R-prec tradeoff between CFG=5 (FID=6.60) and CFG=10 (FID=6.96)
# CFG=5: FID=6.603, R-prec@1=0.671; CFG=10: FID=6.963, R-prec@1=0.767; CFG=15: FID=7.400, R-prec@1=0.797
CHECKPOINT=/hnvme/workspace/v103fe12-ped_gen/models/mld/ego_motion_diffusion_interaction_crop_weighted_1_helma/checkpoints/epoch=4399.ckpt
