#!/bin/bash -l
#SBATCH --job-name=eval_cfg_sweep
#SBATCH --output=/hnvme/workspace/v103fe12-ped_gen/outputs/eval_cfg_sweep_%j.txt
#SBATCH --time=8:00:00
#SBATCH --nodes=1
...
# Use best available checkpoint — update to epoch=4999 once training finishes
...
for CFG in 5 10 15 20; do
    echo "===== CFG guidance_scale=${CFG} ====="
    python -m test \
