#!/bin/bash -l
#SBATCH --job-name=eval_h2_final
#SBATCH --output=/hnvme/workspace/v103fe12-ped_gen/outputs/eval_h2_final_%j.txt
#SBATCH --time=4:00:00
#SBATCH --nodes=1
...
# Evaluate H2 final epoch=4999 at CFG=5 (best FID guidance scale from sweep)
CHECKPOINT=/hnvme/workspace/v103fe12-ped_gen/models/mld/ego_motion_diffusion_interaction_crop_weighted_1_helma/checkpoints/epoch=4999.ckpt
