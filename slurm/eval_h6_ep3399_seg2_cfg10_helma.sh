#!/bin/bash -l
#SBATCH --job-name=eval_h6_ep3399s2_cfg10
#SBATCH --output=/hnvme/workspace/v103fe12-ped_gen/outputs/eval_h6_ep3399s2_cfg10_%j.txt
#SBATCH --time=4:00:00
#SBATCH --nodes=1
...
# Evaluate H6 seg-2 best checkpoint at epoch=3399, CFG=10
# ep=3399: training-time val FID=5.141, R@1=0.380 — best in seg-2 so far
# Confirming whether this is the true peak before deciding on H8
EPOCH=3399
CHECKPOINT=/hnvme/workspace/v103fe12-ped_gen/models/mld/ego_motion_diffusion_h6_unfreeze_ego/checkpoints/epoch=${EPOCH}.ckpt
